...
<div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="{{ route('universitas.store')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                      <div class="form-group">
                        <label for="nama_univ">Nama universitas</label>
                        <input name='nama_univ' type="text" class="form-control" placeholder="nama univ">
                      </div>
                      <div class="form-group">
